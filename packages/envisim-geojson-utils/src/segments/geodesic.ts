 ...
 */
export function destination(point: GJ.Position, dist: number, azimuth: number): GJ.Position2 {
 ...
 * @returns the coordinates [lon,lat] of the destination point.
 */
export function destinationUnrolled(
  point: GJ.Position,
  dist: number,
  azimuth: number,
): GJ.Position2 {
 ...
 * @returns the forward azimuth in degrees.
 */
export function forwardAzimuthDistance(p1: GJ.Position, p2: GJ.Position): [number, number] {
...
export function intermediate(p1: GJ.Position, p2: GJ.Position, fraction: number): GJ.Position2 {
  const [azimuth, dist] = forwardAzimuthDistance(p1, p2);
 ...
 */
export function areaOfRing(coords: GJ.Position[]): number {
