...
// New function in geojson-utils module.
...
/**
 * Rotates coord around refCoord clockwise by angle. Uses conversion first to
 * polar coordinates and then to cartesian [x,y,z] vectors on
 * the unit sphere. Then converts back to [lon,lat] after rotation.
 *
